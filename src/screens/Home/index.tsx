...
export function Home() {
  ...
  async function handleSignOut(){// creates a function to handle sign out
    try{
      // try to call and wait signOut
      await signOut();
    }catch(error){
      Alert.alert('Erro SignOut','Ocorreu um erro ao tentar se deslogar do app');// if fails, display an Alert with the title "Erro SignOut" and message "Ocorreu um erro ao tentar se deslogar do app"
    }
  }
